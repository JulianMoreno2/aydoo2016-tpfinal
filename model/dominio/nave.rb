...
class Nave < ObjetoEspacial
  ...
  def mapa_efectos
    @hash_map = {Nave => EfectoDestructivo.new(100), Misil => EfectoDestructivo.new(80), Bomba => EfectoDestructivo.new(50), Asteroide => EfectoMasa.new(-50), Estrella => EfectoConstructivo.new}
  end
